...
sem opisal v programu [einsteinPS.lgo](../code/einsteinPS.lgo). V FMSlogu naprej naložimo (z izbiro load) knjžnico  [Logo2PS](../blob/main/code/Logo2PS.lgo) in nato še sam program einsteinPS.lgo. Sliko dobimo na zaslonu in na datoteki einstein.eps. To si lahko ogledamo v Acrobat readerju in shranimo v obliki [PDF]().
